...
<select class="form-control" name="published">
  @if (isset($article->id))
    <option value="0" @if ($article->published == 0) selected="" @endif>Don`t Published</option>
...
<input type="text" class="form-control" name="meta_keyword" placeholder="Keywords (1 , 2)" value="{{$article->meta_keyword or ""}}">
